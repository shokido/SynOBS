    ...
    for mem in range(mem_start,mem_end+1):
      ...
      for ivar in range(0,nvar):
        for lt in range(1,lead_times[im-1]+1):
          ...
          leadtime_str='D'+'{:0>3d}'.format((lt-1)*interval+1)
          leadtime_end='D'+'{:0>3d}'.format(lt*interval)
          ...
          nc_out[timename].long_name="Initial time of the valid week"
